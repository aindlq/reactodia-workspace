import { r as __toESM, t as __commonJSMin } from "./common-B-1-B7_t.js";
//#region node_modules/webcola/dist/src/powergraph.js
var require_powergraph = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Configuration = function() {
		...
		Configuration.prototype.initModulesFromGroup = function(group) {
			...
			for (var i = 0; i < group.leaves.length; ++i) {
				...
				var module$1 = new Module(node.id);
				this.modules[node.id] = module$1;
				moduleSet.add(module$1);
			}
		...
		Configuration.prototype.greedyMerge = function() {
			for (var i = 0; i < this.roots.length; ++i) {
				...
				var m = this.rootMerges(i).sort(function(a, b) {
	...
	var LinkSets = function() {
		...
		LinkSets.prototype.add = function(linktype, m) {
			(linktype in this.sets ? this.sets[linktype] : this.sets[linktype] = new ModuleSet()).add(m);
			++this.n;
		};
...
//#endregion
//#region node_modules/webcola/dist/src/linklengths.js
var require_linklengths = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function generateDirectedEdgeConstraints(n, links, axis, la) {
		...
		links.forEach(function(l) {
			...
			if (nodes[ui] !== nodes[vi]) constraints.push({
				axis,
				left: ui,
				right: vi,
...
//#endregion
//#region node_modules/webcola/dist/src/descent.js
var require_descent = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var Locks = function() {
		function Locks() {
			this.locks = {};
	...
	exports.Descent = function() {
		...
		Descent.prototype.offsetDir = function() {
			...
			for (var i = 0; i < this.k; ++i) {
				var x = u[i] = this.random.getNextBetween(.01, 1) - .5;
				l += x * x;
			}
			l = Math.sqrt(l);
		...
		Descent.prototype.computeDerivatives = function(x) {
			...
			for (var u = 0; u < numNodes; ++u) for (i = 0; i < this.k; ++i) {
				...
				var f = m % 1;
				var q = m - f;
				var dx = Math.abs(f) <= .5 ? xiu - q * g : xiu > 0 ? xiu - (q + 1) * g : xiu - (q - 1) * g;
				if (-r < dx && dx <= r) if (this.scaleSnapByMaxH) {
		...
		Descent.prototype.computeNextPosition = function(x0, r) {
			...
			if (this.project) {
				...
				beta = Math.max(.2, Math.min(beta, 1));
...
//#endregion
//#region node_modules/webcola/dist/src/vpsc.js
var require_vpsc = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var Solver = function() {
		...
		Solver.prototype.satisfy = function() {
			...
			while ((v = this.mostViolated()) && (v.equality || v.slack() < Solver.ZERO_UPPERBOUND && !v.active)) {
				var lb = v.left.block;
				if (lb !== v.right.block) this.bs.merge(v);
				else {
...
//#endregion
//#region node_modules/webcola/dist/src/rbtree.js
var require_rbtree = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.RBTree = function(_super) {
			...
			while (node.get_child(dir) !== null) {
				...
				if (!RBTree.is_red(node) && !RBTree.is_red(node.get_child(dir))) {
					if (RBTree.is_red(node.get_child(!dir))) {
						...
						if (sibling !== null) if (!RBTree.is_red(sibling.get_child(!last)) && !RBTree.is_red(sibling.get_child(last))) {
							p.red = false;
							sibling.red = true;
							node.red = true;
						} else {
...
//#endregion
//#region node_modules/webcola/dist/src/rectangle.js
var require_rectangle = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __extends = exports && exports.__extends || (function() {
		var extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
			d.__proto__ = b;
		} || function(d, b) {
	...
	var Rectangle = function() {
		...
		Rectangle.lineIntersection = function(x1, y1, x2, y2, x3, y3, x4, y4) {
			...
			var dx31 = x1 - x3, dy31 = y1 - y3, a = (dx34 * dy31 - dy34 * dx31) / denominator, b = (dx12 * dy31 - dy12 * dx31) / denominator;
		...
		function Projection(nodes, groups, rootGroup, constraints, avoidOverlaps) {
			...
			if (avoidOverlaps && rootGroup && typeof rootGroup.groups !== "undefined") {
				...
				groups.forEach(function(g) {
					_this.variables[i] = g.minVar = new IndexedVariable(i++, typeof g.stiffness !== "undefined" ? g.stiffness : .01);
					_this.variables[i] = g.maxVar = new IndexedVariable(i++, typeof g.stiffness !== "undefined" ? g.stiffness : .01);
				});
			}
		}
...
//#endregion
//#region node_modules/webcola/dist/src/pqueue.js
var require_pqueue = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var PairingHeap = function() {
		...
		PairingHeap.prototype.contains = function(h) {
			...
			for (var i = 0; i < this.subheaps.length; i++) if (this.subheaps[i].contains(h)) return true;
			return false;
		};
...
//#endregion
//#region node_modules/webcola/dist/src/shortestpaths.js
var require_shortestpaths = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/webcola/dist/src/geom.js
var require_geom = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __extends = exports && exports.__extends || (function() {
		var extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
			d.__proto__ = b;
		} || function(d, b) {
	...
	exports.PolyPoint = function(_super) {
	...
	function ConvexHull(S) {
		...
		if (minmax === n - 1) {
			...
			while (++i <= maxmin) {
				...
				while (H.length > 1) if (isLeft(H[H.length - 2], H[H.length - 1], P[i]) > 0) break;
				else H.length -= 1;
			...
			while (--i >= minmax) {
				...
				while (H.length > bot) if (isLeft(H[H.length - 2], H[H.length - 1], P[i]) > 0) break;
				else H.length -= 1;
				if (i != minmin) H.push(P[i]);
			}
		}
	...
	function tangent_PolyPolyC(V, W, t1, t2, cmp1, cmp2) {
		var ix1 = t1(W[0], V), ix2 = t2(V[ix1], W);
		var done = false;
		while (!done) {
			done = true;
			while (true) {
	...
	exports.TVGPoint = function(_super) {
	...
	exports.TangentVisibilityGraph = function() {
		...
		TangentVisibilityGraph.prototype.intersectsPolys = function(l, i1, i2) {
			for (var i = 0, n = this.P.length; i < n; ++i) if (i != i1 && i != i2 && intersects(l, this.P[i]).length > 0) return true;
			return false;
		};
...
//#endregion
//#region node_modules/webcola/dist/src/handledisconnected.js
var require_handledisconnected = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var packingOptions = {
		PADDING: 10,
...
//#endregion
//#region node_modules/webcola/dist/src/layout.js
	...
	exports.Layout = function() {
		...
		Layout.prototype.alpha = function(x) {
			if (!arguments.length) return this._alpha;
				...
				x = +x;
				if (this._alpha) if (x > 0) this._alpha = x;
				else this._alpha = 0;
				else if (x > 0) {
					if (!this._running) {
						this._running = true;
		...
		Layout.prototype.start = function(initialUnconstrainedIterations, initialUserConstraintIterations, initialAllConstraintsIterations, gridSnapIterations, keepRunning, centerGraph) {
			...
			if (centerGraph === void 0) centerGraph = true;
			var i, n = this.nodes().length, N = n + 2 * this._groups.length;
			this._links.length;
			var w = this._canvasSize[0], h = this._canvasSize[1];
			...
			if (this._rootGroup && typeof this._rootGroup.groups !== "undefined") {
				...
				this._groups.forEach(function(g) {
					addAttraction(i, i + 1, _this._groupCompactness, .1);
					x[i] = 0, y[i++] = 0;
					x[i] = 0, y[i++] = 0;
				});
		...
		Layout.prototype.routeEdge = function(edge, ah, draw) {
			...
			var sourceInd = function(e) {
				...
				return e.length();
			}, shortestPath = new shortestpaths_1.Calculator(vg2.V.length, vg2.E, sourceInd, targetInd, length).PathFromNodeToNode(start.id, end.id);
...
//#endregion
//#region node_modules/webcola/dist/src/adaptor.js
var require_adaptor = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __extends = exports && exports.__extends || (function() {
		var extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
			d.__proto__ = b;
		} || function(d, b) {
...
//#endregion
//#region node_modules/webcola/dist/src/d3v3adaptor.js
var require_d3v3adaptor = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __extends = exports && exports.__extends || (function() {
		var extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
			d.__proto__ = b;
		} || function(d, b) {
...
//#endregion
//#region node_modules/webcola/dist/src/d3v4adaptor.js
var require_d3v4adaptor = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __extends = exports && exports.__extends || (function() {
		var extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
			d.__proto__ = b;
		} || function(d, b) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var layout_1 = require_layout();
	exports.D3StyleLayoutAdaptor = function(_super) {
		__extends(D3StyleLayoutAdaptor, _super);
...
//#endregion
//#region node_modules/webcola/dist/src/d3adaptor.js
var require_d3adaptor = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function isD3V3(d3Context) {
		return d3Context.version && d3Context.version.match(/^3\./) !== null;
	}
}));
//#endregion
//#region node_modules/webcola/dist/src/gridrouter.js
var require_gridrouter = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var rectangle_1 = require_rectangle();
	var vpsc_1 = require_vpsc();
	var shortestpaths_1 = require_shortestpaths();
	...
	exports.GridRouter = function() {
		function GridRouter(originalnodes, accessor, groupPadding) {
			...
			this.backToFront.slice(0).reverse().filter(function(g) {
				return !g.leaf;
			}).forEach(function(v) {
			...
			lines.forEach(function(l, li) {
				...
				var isHoriz = Math.abs(l.y1 - l.y2) < .1;
		...
		GridRouter.getSegmentSets = function(routes, x, y) {
			...
			for (var ei = 0; ei < routes.length; ei++) {
				...
				for (var si = 0; si < route.length; si++) {
					...
					s.i = si;
					var sdx = s[1][x] - s[0][x];
					if (Math.abs(sdx) < .1) vsegments.push(s);
				}
			}
			...
			for (var i = 0; i < vsegments.length; i++) {
				var s = vsegments[i];
				if (!segmentset || Math.abs(s[0][x] - segmentset.pos) > .1) {
					segmentset = {
						pos: s[0][x],
						segments: []
					};
		...
		GridRouter.nudgeSegs = function(x, y, routes, segments, leftOf, gap) {
			...
			for (var i = 0; i < n; i++) for (var j = 0; j < n; j++) {
				...
				if (x == "x") {
					if (leftOf(e1, e2)) if (s1[0][y] < s1[1][y]) lind = j, rind = i;
					else lind = i, rind = j;
				} else if (leftOf(e1, e2)) if (s1[0][y] < s1[1][y]) lind = i, rind = j;
				else lind = j, rind = i;
				if (lind >= 0) cs.push(new vpsc_1.Constraint(vs[lind], vs[rind], gap));
			}
			new vpsc_1.Solver(vs, cs).solve();
			vs.forEach(function(v, i) {
				var s = segments[i];
				var pos = v.position();
				s[0][x] = s[1][x] = pos;
		...
		GridRouter.prototype.route = function(s, t) {
			...
			var pathPoints = shortestPathCalculator.PathFromNodeToNodeWithPrevCost(source.ports[0].id, target.ports[0].id, bendPenalty).reverse().map(function(vi) {
...
//#endregion
//#region node_modules/webcola/dist/src/layout3d.js
var require_layout3d = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var shortestpaths_1 = require_shortestpaths();
	var descent_1 = require_descent();
	var rectangle_1 = require_rectangle();
	var linklengths_1 = require_linklengths();
	exports.Link3D = function() {
...
//#endregion
//#region node_modules/webcola/dist/src/batch.js
var require_batch = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function gridify(pgLayout, nudgeGap, margin, groupMargin) {
		...
		return route(pgLayout.cola.nodes(), pgLayout.cola.groups(), margin, groupMargin).routeEdges(pgLayout.powerGraph.powerEdges, nudgeGap, function(e) {
	...
	function powerGraphGridLayout(graph, size, grouppadding) {
		...
		return {
			cola: new layout_1.Layout().convergenceThreshold(.001).size(size).avoidOverlaps(true).nodes(graph.nodes).links(graph.links).groupCompactness(1e-4).linkDistance(30).symmetricDiffLinkLengths(5).powerGraphGroups(function(d) {
				powerGraph = d;
				powerGraph.groups.forEach(function(v) {
...
//#endregion
//#region src/diagram/layoutShared.ts
...
function evaluateColaLayout(graph, state, evaluateLayout) {
	...
	for (const [id, node] of Object.entries(graph.nodes)) {
		const bounds = Object.hasOwn(state.bounds, id) ? state.bounds[id] : void 0;
		nodes.set(id, {
			x: bounds ? bounds.x : 0,
			y: bounds ? bounds.y : 0,
	...
	for (const [id, node] of nodes) bounds[id] = {
		x: node.x,
		y: node.y,
		width: node.width ?? 0,
...
function colaForceLayout(graph, state, options) {
	...
	return evaluateColaLayout(graph, state, (nodes, links) => {
		new import_dist.Layout().nodes(Array.from(nodes.values())).links(links).avoidOverlaps(avoidOverlaps).convergenceThreshold(1e-9).jaccardLinkLengths(preferredLinkLength).handleDisconnected(true).start(30, 0, 10, void 0, false);
	});
}
/**
* @category Geometry
...
function colaFlowLayout(graph, state, options) {
	...
	return evaluateColaLayout(graph, state, (nodes, links) => {
		new import_dist.Layout().nodes(Array.from(nodes.values())).links(links).avoidOverlaps(avoidOverlaps).flowLayout(axis, minSeparation).symmetricDiffLinkLengths(preferredLinkLength).start(10, 20, 20, void 0, false);
	});
}
/**
* @category Geometry
...
function colaRemoveOverlaps(state) {
	const nodeRectangles = /* @__PURE__ */ new Map();
	for (const [id, { x, y, width, height }] of Object.entries(state.bounds)) nodeRectangles.set(id, new import_dist.Rectangle(x, x + width, y, y + height));
	import_dist.removeOverlaps(Array.from(nodeRectangles.values()));
	const bounds = Object.create(null);
	for (const [id, { x, y }] of nodeRectangles) {
		const nodeBounds = Object.hasOwn(state.bounds, id) ? state.bounds[id] : void 0;
		bounds[id] = {
			x,
			y,
...
function layoutPadded(state, padding) {
	if (!padding) return {
		state,
		unwrap: (transformed) => transformed
	};
	const paddedBounds = Object.create(null);
	for (const [id, { x, y, width, height }] of Object.entries(state.bounds)) paddedBounds[id] = {
		x: x - padding.x,
		y: y - padding.y,
	...
	return {
		...
		unwrap: (transformed) => {
			...
			for (const [id, { x, y, width, height }] of Object.entries(transformed.bounds)) shrinkBounds[id] = {
				x: x + padding.x,
				y: y + padding.y,
				width: width - padding.x * 2,
				height: height - padding.y * 2
	...
	return {
		...
		unwrap: (transformed) => {
			...
			for (const [id, bounds] of Object.entries(withoutPadding.bounds)) {
				const initialBounds = Object.hasOwn(state.bounds, id) ? state.bounds[id] : void 0;
...
function blockingDefaultLayout(graph, state, options) {
	const { preferredLinkLength = 200, padding = {
		x: 50,
		y: 50
	} } = options ?? {};
	const padded = layoutPaddedBiasFree(colaForceLayout(graph, state, {
		preferredLinkLength,
		avoidOverlaps: false
	}), padding);
...
//#endregion
export { evaluateColaLayout as a, layoutPaddedBiasFree as c, colaRemoveOverlaps as i, colaFlowLayout as n, getContentFittingBoxForLayout as o, colaForceLayout as r, layoutPadded as s, blockingDefaultLayout as t };

//# sourceMappingURL=common-BWsVNoKq.js.map